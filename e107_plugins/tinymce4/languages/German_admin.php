...
define("TMCEALAN_7", "Frontend-Stil verwenden");
define("TMCEALAN_8", "Wenn diese Option aktiviert ist, wird der Editor den Stil des Frontend-Themas verwenden. (wenn unterstützt)");