...
define("GSLAN_51", "Automatisch generiert aus [x]");
define("GSLAN_52", "Sobald Sie einige Einträge vorgenommen haben, gehen Sie zu [URL] und geben Sie eine der folgenden URLs in den Abschnitt Sitemaps ein: [SITEMAP_URLS] (Wenn Ihnen eine dieser URLs falsch erscheint, vergewissern Sie sich bitte, dass Ihre Website-URL in [Einstellungen] korrekt ist).");
define("GSLAN_53", "Anweisungen");